...
const roles = [
  {
    id: 'player',
    title: 'Player',
    description: 'Compete in tournaments, build your esports profile, and connect with other players',
    icon: Gamepad2,
  ...
  },
  {
    id: 'organiser',
    title: 'Organiser',
    description: 'Create tournaments, manage events, and build your esports community',
    icon: Users,
  ...
  },
  {
    id: 'creator',
    title: 'Creator',
    description: 'Share your content, showcase your talent, and monetize your esports passion',
    icon: Camera,
